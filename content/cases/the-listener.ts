    ...
    // ------------------------------------------------------------ t-listener
    {
      ...
      messages: [
        ...
        },
        {
          ...
          senderId: 'listener',
          sentAt: 80,
          body: 'I thought less of the ferry business. You had him on the second day and you spent four more making certain, and I understand why, but there is a version of you that does not need the four days and I have met her.',
        },
        {
          id: 'l4',
          threadId: 't-listener',
        ...
        },
        {
          ...
          senderId: 'you',
          sentAt: 3404,
          body: 'the call to the cafe was a clerk at the auditors. gordon and sime had four temps on that account that autumn and one of them phoned the wrong number with the wrong file open and never knew. it was a coincidence. everything since has been me building a man out of one bad phone call',
        },
        {
          id: 'l7',
          threadId: 't-listener',
    ...
    // --------------------------------------------------- t-mairi (discovery)
    {
      ...
      messages: [
        ...
        },
        {
          ...
          senderId: 'you',
          sentAt: 2814,
          body: 'the man on the phone. what did he say. the exact words',
        },
        {
          id: 'm4',
          threadId: 't-mairi',
